...
class AppColors(
    ...
    systemButtonPrimaryColor: Color,
    ...
    fun copy(
        ...
        systemButtonPrimaryColor: Color = this.systemButtonPrimaryColor,
    ...
    fun updateColorsFrom(other: AppColors) {
        ...
        systemButtonPrimaryColor = other.systemButtonPrimaryColor
...
private val SystemButtonPrimaryColor = Color(0xFF84ED0A)
...
fun appLightColors(
    ...
    systemButtonPrimaryColor: Color = SystemButtonPrimaryColor,
    ...
    systemButtonPrimaryColor = systemButtonPrimaryColor,
